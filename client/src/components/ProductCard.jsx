      ...
      <div className="p-4 bg-white product-body">
        <div className="product-top">
          ...
          <div className="mt-3 text-sm text-slate-500 flex items-center gap-3">
            ...
            <span>{product.location || 'Your farm'}</span>
          </div>
        </div>
        ...
        <div className="product-bottom mt-3 flex flex-col">
          ...
          <div className="mt-2 text-2xl font-bold text-emerald-800">Nu. {product.price} <span className="text-lg font-medium text-slate-500">/{product.unit}</span></div>
