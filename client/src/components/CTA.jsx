...
export default function CTA() {
  return (
    <section className="relative overflow-hidden py-16 bg-gradient-to-r from-emerald-500 via-emerald-600 to-emerald-700 text-white">
  ...
  <div aria-hidden className="pointer-events-none select-none absolute inset-x-0 bottom-0">
        <svg className="block w-full h-16 md:h-20 text-emerald-700" viewBox="0 0 1200 120" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
